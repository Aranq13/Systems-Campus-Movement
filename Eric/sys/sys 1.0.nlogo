...
to setup
clear-all
 import-pcolors "sys_trinity.png"
  ask n-of 5000 patches with [pcolor = white] [set pcolor blue]
...
ask turtle 0 [
    ...
    ifelse [pcolor] of patch-ahead 1 != white
    [ lt random-float 360 ]
    [ move-to one-of patches in-radius 5 ]
...
ifelse any? memory with [pcolor = white] [
let p one-of memory with [pcolor = white]
face p
fd 1
][
set heading random 360
...
ask memory with [pcolor != white and
pcolor != grey]
...
[pcolor = blue] in-radius 10 [distance myself]
